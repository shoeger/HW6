...
<body>
	...
	<ul>
        ...
        <asp:DetailsView ID="DetailsView1" runat="server" AutoGenerateRows="False" DataKeyNames="reID" CssClass="grid-view" DataSourceID="SqlDataSource1" Height="50px" Width="277px" DefaultMode="Insert">
